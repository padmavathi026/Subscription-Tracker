...
COPY Subscription_Info(subscription_id, user_id, service_id, billing_cycle_id, status_id, next_payment_date, auto_renew)
FROM '/Library/PostgreSQL/17/data/Subscription_Info_CLEANED.csv'
DELIMITER ',' CSV HEADER;

COPY Payments_Info(payment_id, subscription_id, amount, date, payment_date, payment_method_id, status)
FROM '/Library/PostgreSQL/17/data/Payments_Info_CLEANED.csv'
DELIMITER ',' CSV HEADER;

COPY Subscription_Metadata(subscription_id, user_id, service_id, billing_cycle_id, status_id, next_payment_date, auto_renew)
FROM '/Library/PostgreSQL/17/data/Subscription_Metadata_CLEANED.csv' 
DELIMITER ',' CSV HEADER;

COPY Notification_Messages(notification_id, subscription_id, amount, date, message, status, sent_at)
FROM '/Library/PostgreSQL/17/data/Notification_Messages_CLEANED.csv' 
DELIMITER ',' CSV HEADER;
